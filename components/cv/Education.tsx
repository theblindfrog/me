export default function Education() {
  return (
    <section className="mb-16 break-after-avoid">
      <h2 className="mb-8 text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl">
        Education
      </h2>
      ...
      <ol>
        <li className="mb-6">
          ...
          <h5 className="text-sm text-gray-600 dark:text-gray-400 uppercase tracking-copperplate">
