<footer class="flex flex-wrap justify-between items-baseline mt-24 mb-6">
    <ul class="text-lg flex text-primary-500 mb-2">
        <li class="mr-4">
        ...
        <li class="mr-4">
            <ion-icon class="-mb-1 text-2xl" name="logo-github"></ion-icon>
