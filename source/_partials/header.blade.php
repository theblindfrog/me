<div class="flex px-4 w-100 md:px-0 items-baseline">
    ...
    <div class="w-golden-2/3">
        <h1 class="
            font-normal leading-none mb-6
            text-3xl tracking-tight
            md:text-4xl md:tracking-tighter
        ">Alexander Powell</h1>
    </div>
    <div class="w-golden-2/6">
        <nav class="list-none m-0 p-0 flex flex-row uppercase font-600 text-gray-700 ">
            <li class="ml-2"><a class="hover:text-blue-700" href="/">About</a></li>
