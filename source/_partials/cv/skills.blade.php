<section class="mb-16">
    <h2 class="mb-6 font-serif text-3xl tracking-tight font-500">Skills &amp; Proficiencies</h2>
    ...
    <div class="flex mb-4">
        <div class="w-5/12">
            ...
            <h5 class="mt-4 mb-2 tracking-wide uppercase font-700">DevOps</h5>
            <ul>
        ...
        <div class="w-5/12 ml-6">
            ...
            <h5 class="mb-2 tracking-wide uppercase font-700">Professional</h5>
            <ul>
