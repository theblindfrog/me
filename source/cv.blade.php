...
@section('body')
            ...
            <li class="mb-12">
                ...
                <ol class="mb-8">
                        ...
                        <h3 class="flex items-baseline justify-between mb-2">
                            <span class="text-lg text-gray-800 font-500">
                                ...
                                On The Move Embedded Utilities Application Form
                                    <svg xmlns='http://www.w3.org/2000/svg' class='inline-block h-4 fill-current -mt-05' viewBox='0 0 512 512'><title>Open</title><path d='M384 224v184a40 40 0 01-40 40H104a40 40 0 01-40-40V168a40 40 0 0140-40h167.48M336 64h112v112M224 288L440 72' fill='none' stroke='currentColor' stroke-linecap='round' stroke-linejoin='round' stroke-width='32'/></svg>
                                </a>
                            </span>
                    ...
                    <li class="mb-6">
                        <h3 class="flex items-baseline justify-between mb-2">
                            <span class="text-lg text-gray-800 font-500">
                                <a class="hover:text-primary-500" href="https://www.clickenergy.com.au/quick-quote-calculator" target="_blank">
                ...
                <dl class="mb-8">
                    ...
                    <dd class="mb-4 italic text-gray-700 lg:w-3/4">Quarterly winners are nominated by peers, who represent reliability. We build reliable products full of fail safes and back-ups. Reliability is also about being committed to the amaysim way and being responsible and authentic in our behavior.</dd>
                    ...
                    <dd class="mb-4 italic text-gray-700 lg:w-3/4">Quarterly winners are nominated by peers, who represent agility. Agility is about reacting quickly, applying mental flexibility when a problem needs to be solved and always holding on to the entrepreneurial spirit.</dd>

                    <dt class="flex items-baseline justify-between mb-2 text-lg">
                        <span>Outside the Box Thinker Award</span>
                        <small class="text-sm text-right text-gray-600 uppercase tracking-copperplate">2018</small>
                    </dt>
                    <dd class="mb-4 italic text-gray-700 lg:w-3/4">Awarded to an individual who finds creative and divergent ways of solving problems across the business.</dd>
                    
                    <dt class="flex items-baseline justify-between mb-2 text-lg">
                        <span>Above and Beyond Award</span>
                        <small class="text-sm text-right text-gray-600 uppercase tracking-copperplate">2017</small>
                    </dt>
                    <dd class="mb-4 italic text-gray-700 lg:w-3/4">Awarded to someone who goes beyond of what's required of them and delivers exceptional value to the business.</dd>
                    
                    <dt class="flex items-baseline justify-between mb-2 text-lg">
                        <span>Manager Directors' Award</span>
                        <small class="text-sm text-right text-gray-600 uppercase tracking-copperplate">2016</small>
                    </dt>
                    <dd class="mb-4 italic text-gray-700 lg:w-3/4">The "MVP" of the year, awarded at the discretion of the Managing Director <small>(or CEO in other years)</small> to the individual who has made the most impact to the business for the year.</dd>
    ...
    <section class="mb-16">
        <h2 class="mb-6 font-serif text-3xl tracking-tight font-500">Education</h2>
    ...
    <section class="mb-16">
        <h2 class="mb-6 font-serif text-3xl tracking-tight font-500">Skills</h2>
        ...
        <div class="flex mb-4">
            <div class="w-5/12">
                ...
                <ul>
                    <li>PHP</li>
                    <li>CSS <small class="uppercase">(SASS, PostCSS)</small></li>
                    <li>Javascript <small class="uppercase">(ES5, ES6)</small></li>
                    <li>HTML</li>
        ...
        <div class="flex mb-4">
            <div class="w-5/12">
                ...
                <h5 class="mb-2 tracking-wide uppercase font-700">Design</h5>
                <ul>
                    <li>Web Design</li>
                    <li>Print</li>
                    <li>Logo / Identity</li>
