    ...
    <ol>
        ...
        <li class="mb-12">
            ...
            <h4 class="mb-4 tracking-wide text-gray-700 uppercase font-700">
                ...
                Key Responsibilities</h4>
            <ul class="mb-8 ml-4 space-y-1 list-disc">
                <li>Creation and ownership of the vast majority of digital assets & processes for both Click and On The Move</li>
                ...
                <li>A/B testing, conversion optimization, and session recording
